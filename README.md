...
- [ ] **Config SonarCloud**
  ...
  - Remember to replace the file at /.github/workflows/sonar.yml with the yaml file at https://sonacloud.io and if your Java project is not on Java 11, edit this yaml file.
